...
-- Вывести все счета, оформленные после 02.01.2010 года, сумма которых менее 3$
select *
from invoices
where DATE (InvoiceDate) = '2010-02-01' and Total < 3

-- Вывести все счета, которые были выставлены в городе, название которого начинается на букву Р, а общая сумма превышает 2$
select *
from invoices
where BillingCity like 'P%' and Total > 2

-- Вывести все счета, выставленных в городах, названия которых начинаются с буквы Р или с буквы D
select *
from invoices
where BillingCity like 'P%' or BillingCity like 'D%'

-- Вывести все счета на сумму свыше 1,98$ из лююбых городов, названия которых начинаются с буквы P или D 
select *
from invoices
where Total > 1.98 and (BillingCity like 'P%' or BillingCity like 'D%') 

-- Вывести все счета на сумму выше 3$,  выставленных в городах, названия которых начинается с буквы P или D 
select *
from invoices
where Total > 3 and (BillingCity like 'P%' or BillingCity like'D')
